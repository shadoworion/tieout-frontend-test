...
export const AG_GRID_LOCALE_IL = {
  ...
  advancedFilterValidationJoinOperatorMismatch:
    "המפעילים בתנאי חייבים להיות אותו דבר",
  ...
  advancedFilterValidationMessage:
    "יש שגיאה בביטוי. ${variable} - ${variable}.",
  advancedFilterValidationMessageAtEnd:
    "יש שגיאה בביטוי. ${variable} בסוף הביטוי.",
  ...
  ariaAdvancedFilterBuilderItem:
    "${variable}. רמה ${variable}. לחץ על ENTER כדי לערוך.",
  ariaAdvancedFilterBuilderItemValidation:
    "${variable}. רמה ${variable}. ${variable} לחץ על ENTER כדי לערוך.",
  ...
  ariaLabelRichSelectDeselectAllItems:
    "לחץ על מקש מחיקה כדי לבטל את הבחירה בכל הפריטים",
  ariaLabelRichSelectDeleteSelection:
    "לחץ על מקש מחיקה כדי לבטל את בחירת הפריט",
  ...
  ariaLabelAdvancedFilterBuilderColumnSelectField:
    "בחר שדה עמודה בבונה הסינון המתקדם",
  ariaLabelAdvancedFilterBuilderOptionSelectField:
    "בחר שדה אפשרות בבונה הסינון המתקדם",
  ariaLabelAdvancedFilterBuilderJoinSelectField:
    "בחר שדה אופרטור הצטרפות בבונה הסינון המתקדם",
